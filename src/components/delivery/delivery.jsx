...
export default function Deliver() {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      try {
        ...
        const response = await axios.get("https://eatify-frontend.vercel.app//delivery");
        ...
        const response2 = await axios.post("https://eatify-frontend.vercel.app//delivery", {
          action: "2",
          deliveryPartner,
        });
        ...
        const response4 = await axios.post("https://eatify-frontend.vercel.app//delivery", {
          action: "4",
  ...
  const handleAcceptOrder = async (orderId) => {
    ...
    if (orderToAccept) {
      ...
      await axios.patch("https://eatify-frontend.vercel.app//delivery", {
        id: orderId,
        name: localStorage.getItem('name'),
        email: jwtDecode(userToken).email
      });

      await axios.post("https://eatify-frontend.vercel.app//delivery", {
        action: "1",
        order: { ...orderToAccept, deliveryPartner: localStorage.getItem('name') }
      });
      startLoading();
      try {
        const response = await axios.delete(`https://eatify-frontend.vercel.app//delivery`, {
  ...
  const sendOtp = async () => {
    try {
      ...
      setLoading(true);
      const callBack = await axios.post("https://eatify-frontend.vercel.app//send-otp", {
  ...
  const verifyOtpAndDeliverOrder = async (orderId) => {
    ...
    try {
      ...
      const response = await axios.post("https://eatify-frontend.vercel.app//verify-otp", {
        orderId: acceptedOrder.id,
        otp: otp,
      });
      ...
      if (response.status == 200) {
        ...
        const response3 = await axios.post("https://eatify-frontend.vercel.app//delivery", {
          action: "3",
        ...
        if (response3.status == 200) {
          ...
          const response2 = await axios.delete(`https://eatify-frontend.vercel.app//delivery`, {
