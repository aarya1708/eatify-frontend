  ...
  useEffect(() => {
    ...
    const fetchRestaurant = async () => {
      try {
        ...
        const response = await axios.post("https://eatify-frontend.vercel.app//rest-acc", { name: restaurantName });
    
        setRestaurant(response.data);
      
        const response2 = await axios.post("https://eatify-frontend.vercel.app//rest-earnings", { email: response.data.email });
